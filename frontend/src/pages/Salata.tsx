...
export default function Salata() {
  ...
  useEffect(() => {
    api.get("/category").then(res => {
      const salata = res.data.find((c: any) => c.categoryName.toLowerCase() === "salata");
      if (salata) {
        setProducts(salata.foodProducts || []);
      }
    });
  }, []);
