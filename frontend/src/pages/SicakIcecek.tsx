...
export default function SicakIcecek() {
  ...
  useEffect(() => {
    api.get("/category").then(res => {
      const sicak = res.data.find((c: any) => c.categoryName.toLocaleLowerCase('tr-TR') === "sıcak içecek");
      if (sicak) {
        setProducts(sicak.foodProducts || []);
      }
    });
  }, []);
  ...
  return (
    <div className="main-content">
      ...
      <h2 className="title">Sıcak İçecek</h2>
