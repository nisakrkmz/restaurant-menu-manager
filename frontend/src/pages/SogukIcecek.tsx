...
export default function SogukIcecek() {
  ...
  useEffect(() => {
    api.get("/category").then(res => {
      const soguk = res.data.find((c: any) => c.categoryName.toLocaleLowerCase('tr-TR') === "soğuk içecek");
      if (soguk) {
        setProducts(soguk.foodProducts || []);
      }
    });
  }, []);
  ...
  return (
    <div className="main-content">
      ...
      <h2 className="title">Soğuk İçecek</h2>
